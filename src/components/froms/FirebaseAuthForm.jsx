      ...
      <div className="mt-6">
        ...
        <div className="mt-6 grid grid-cols-1 gap-3">
          <button
            ...
            className="w-full inline-flex justify-center bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
          >
            <svg
              width="189"
              height="40"
          ...
          <p>
            ...
            <button
              ...
              onClick={() => {
                ...
                const event = new CustomEvent("toggleAuthMode", {
                  detail: "signup",
                });
