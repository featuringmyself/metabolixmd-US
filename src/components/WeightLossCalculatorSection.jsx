      ...
      >
        ...
        >
          ...
          <stop offset="1"/>
            ...
            <h3 className="text-2xl font-semibold text-white mb-2 text-center" style={{textShadow: '0 1px 8px rgba(0,0,0,0.25)'}}>Lab tested & Certified</h3>
            <p className="text-white text-base leading-relaxed text-center" style={{textShadow: '0 1px 8px rgba(0,0,0,0.25)'}}>Filled and shipped same day as your appointment</p>
          </div>
        </motion.div>
      </div>
    </section>
